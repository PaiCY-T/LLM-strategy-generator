...
rsi_rank = rsi_factor.rank(axis=1, pct=True) # Normalize RSI
# Assign weights - momentum and quality are key, revenue and flow add diversification, RSI for short-term signals
...
rsi_filter = (rsi_factor > 25) & (rsi_factor < 75)
