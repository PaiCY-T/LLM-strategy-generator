# template-system-phase2 - Task 38

Execute task 38 for the template-system-phase2 specification.

## Task Description
Implement performance-based template recommendation
...
## Usage
```
/Task:38-template-system-phase2
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement performance-based template recommendation"

```
Use the @spec-task-executor agent to implement task 38: "Implement performance-based template recommendation" for the template-system-phase2 specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Implement performance-based template recommendation
- Requirements: 4.2

## Instructions
- Implement ONLY task 38: "Implement performance-based template recommendation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-system-phase2 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-system-phase2 38 --mode complete
```
