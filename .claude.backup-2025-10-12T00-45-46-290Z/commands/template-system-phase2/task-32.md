# template-system-phase2 - Task 32

Execute task 32 for the template-system-phase2 specification.
...
## Usage
```
/Task:32-template-system-phase2
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement fix suggestion generator"

```
Use the @spec-task-executor agent to implement task 32: "Implement fix suggestion generator" for the template-system-phase2 specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Implement fix suggestion generator
- Requirements: 3.4

## Instructions
- Implement ONLY task 32: "Implement fix suggestion generator"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-system-phase2 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-system-phase2 32 --mode complete
```
