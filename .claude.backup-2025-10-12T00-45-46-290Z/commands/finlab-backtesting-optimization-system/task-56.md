# finlab-backtesting-optimization-system - Task 56

Execute task 56 for the finlab-backtesting-optimization-system specification.
...
**Requirements**: Usability NFR (onboarding tutorial), AC-7.4

## Usage
```
/Task:56-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create tutorial manager"

```
Use the @spec-task-executor agent to implement task 56: "Create tutorial manager" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 56
- Description: Create tutorial manager
- Leverage: streamlit session
- Requirements: Usability NFR (onboarding tutorial), AC-7.4

## Instructions
- Implement ONLY task 56: "Create tutorial manager"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 56 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 56 --mode complete
```
