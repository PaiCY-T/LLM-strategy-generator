...
|--------|-------|----------------|
| Factor Diversity | 0.466 | Low (>0.5 recommended) |
| Average Correlation | 0.500 | Good (<0.8 recommended) |
| Risk Diversity | 0.000 | Low (>0.3 recommended) |

## Factor Analysis

**Total Unique Factors**: 13
**Average Factors per Strategy**: 6.3
...
| 1 | `price:成交金額` | 6 |
| 2 | `etl:adj_close` | 6 |
| 3 | `monthly_revenue:去年同月增減(%)` | 4 |
| 4 | `institutional_investors_trading_summary:外陸資買賣超股數(不含外資自營商)` | 4 |
| 5 | `indicator:RSI` | 4 |
| 6 | `fundamental_features:ROE稅後` | 4 |
| 7 | `price_earning_ratio:股價淨值比` | 2 |
| 8 | `monthly_revenue:上月比較增減(%)` | 2 |
| 9 | `etl:market_value` | 2 |
| 10 | `price_earning_ratio:本益比` | 1 |
...
- Low factor diversity detected: 0.466 < 0.5
