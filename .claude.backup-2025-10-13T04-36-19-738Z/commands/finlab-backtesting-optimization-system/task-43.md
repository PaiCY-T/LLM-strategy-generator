# finlab-backtesting-optimization-system - Task 43

Execute task 43 for the finlab-backtesting-optimization-system specification.

## Task Description
Implement rule-based suggestion generator
...
## Usage
```
/Task:43-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement rule-based suggestion generator"

```
Use the @spec-task-executor agent to implement task 43: "Implement rule-based suggestion generator" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: Implement rule-based suggestion generator
- Requirements: AC-3.9, Design Component 4

## Instructions
- Implement ONLY task 43: "Implement rule-based suggestion generator"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 43 --mode complete
```
