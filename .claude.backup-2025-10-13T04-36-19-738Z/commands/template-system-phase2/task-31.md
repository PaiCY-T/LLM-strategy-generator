# template-system-phase2 - Task 31

Execute task 31 for the template-system-phase2 specification.

## Task Description
Implement MastiffTemplate specific validation
...
## Usage
```
/Task:31-template-system-phase2
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement MastiffTemplate specific validation"

```
Use the @spec-task-executor agent to implement task 31: "Implement MastiffTemplate specific validation" for the template-system-phase2 specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Implement MastiffTemplate specific validation
- Requirements: 3.3

## Instructions
- Implement ONLY task 31: "Implement MastiffTemplate specific validation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-system-phase2 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-system-phase2 31 --mode complete
```
