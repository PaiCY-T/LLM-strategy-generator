# finlab-backtesting-optimization-system - Task 24

Execute task 24 for the finlab-backtesting-optimization-system specification.

## Task Description
Implement performance metrics calculation

## Code Reuse
**Leverage existing code**: finlab report.metrics methods, pandas operations

## Requirements Reference
**Requirements**: AC-2.2, AC-2.3, AC-2.4, AC-2.5

## Usage
```
/Task:24-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement performance metrics calculation"

```
Use the @spec-task-executor agent to implement task 24: "Implement performance metrics calculation" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Implement performance metrics calculation
- Leverage: finlab report.metrics methods, pandas operations
- Requirements: AC-2.2, AC-2.3, AC-2.4, AC-2.5

## Instructions
- Implement ONLY task 24: "Implement performance metrics calculation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 24 --mode complete
```
