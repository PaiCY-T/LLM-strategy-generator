# template-system-phase2 - Task 21

Execute task 21 for the template-system-phase2 specification.

## Task Description
Implement similarity query with cosine distance

## Requirements Reference
**Requirements**: 2.5, NFR Performance.4

## Usage
```
/Task:21-template-system-phase2
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement similarity query with cosine distance"

```
Use the @spec-task-executor agent to implement task 21: "Implement similarity query with cosine distance" for the template-system-phase2 specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Implement similarity query with cosine distance
- Requirements: 2.5, NFR Performance.4

## Instructions
- Implement ONLY task 21: "Implement similarity query with cosine distance"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-system-phase2 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-system-phase2 21 --mode complete
```
