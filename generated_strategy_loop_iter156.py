...
# Revenue YoY is monthly, so ffill and then shift
...
# Combine fundamental factors into a single 'Fundamental Strength' rank
fundamental_strength_rank = (quality_roe_rank * 0.6 + growth_revenue_rank * 0.4)
# Combine all major factors with chosen weights
