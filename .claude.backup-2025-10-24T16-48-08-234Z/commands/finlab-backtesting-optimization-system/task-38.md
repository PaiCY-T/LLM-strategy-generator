# finlab-backtesting-optimization-system - Task 38

Execute task 38 for the finlab-backtesting-optimization-system specification.

## Task Description
Implement failed pattern identification

## Requirements Reference
**Requirements**: AC-4.4, Design Component 5

## Usage
```
/Task:38-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement failed pattern identification"

```
Use the @spec-task-executor agent to implement task 38: "Implement failed pattern identification" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Implement failed pattern identification
- Requirements: AC-4.4, Design Component 5

## Instructions
- Implement ONLY task 38: "Implement failed pattern identification"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 38 --mode complete
```
