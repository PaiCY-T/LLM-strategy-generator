# finlab-backtesting-optimization-system - Task 22

Execute task 22 for the finlab-backtesting-optimization-system specification.

## Task Description
Implement code execution sandbox with resource limits

## Code Reuse
**Leverage existing code**: resource, signal modules

## Requirements Reference
**Requirements**: Security NFR, Design Security #2

## Usage
```
/Task:22-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement code execution sandbox with resource limits"

```
Use the @spec-task-executor agent to implement task 22: "Implement code execution sandbox with resource limits" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Implement code execution sandbox with resource limits
- Leverage: resource, signal modules
- Requirements: Security NFR, Design Security #2

## Instructions
- Implement ONLY task 22: "Implement code execution sandbox with resource limits"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 22 --mode complete
```
