# population-based-learning - Task 2

Execute task 2 for the population-based-learning specification.

## Task Description
Define MultiObjectiveMetrics dataclass in src/evolution/types.py

## Code Reuse
**Leverage existing code**: Python dataclasses
...
## Usage
```
/Task:2-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Define MultiObjectiveMetrics dataclass in src/evolution/types.py"

```
Use the @spec-task-executor agent to implement task 2: "Define MultiObjectiveMetrics dataclass in src/evolution/types.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Define MultiObjectiveMetrics dataclass in src/evolution/types.py
- Leverage: Python dataclasses
- Requirements: R6.1

## Instructions
- Implement ONLY task 2: "Define MultiObjectiveMetrics dataclass in src/evolution/types.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 2 --mode complete
```
