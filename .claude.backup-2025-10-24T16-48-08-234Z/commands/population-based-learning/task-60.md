# population-based-learning - Task 60

Execute task 60 for the population-based-learning specification.

## Task Description
Create user documentation in docs/POPULATION_EVOLUTION_GUIDE.md
...
## Usage
```
/Task:60-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create user documentation in docs/POPULATION_EVOLUTION_GUIDE.md"

```
Use the @spec-task-executor agent to implement task 60: "Create user documentation in docs/POPULATION_EVOLUTION_GUIDE.md" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 60
- Description: Create user documentation in docs/POPULATION_EVOLUTION_GUIDE.md
- Requirements: R11.2

## Instructions
- Implement ONLY task 60: "Create user documentation in docs/POPULATION_EVOLUTION_GUIDE.md"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 60 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 60 --mode complete
```
