# population-based-learning - Task 40

Execute task 40 for the population-based-learning specification.

## Task Description
Create unit tests for mutation.py

## Code Reuse
**Leverage existing code**: pytest, NumPy for statistical tests
...
## Usage
```
/Task:40-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create unit tests for mutation.py"

```
Use the @spec-task-executor agent to implement task 40: "Create unit tests for mutation.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Create unit tests for mutation.py
- Leverage: pytest, NumPy for statistical tests
- Requirements: R4.1, R4.2, R4.3

## Instructions
- Implement ONLY task 40: "Create unit tests for mutation.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 40 --mode complete
```
