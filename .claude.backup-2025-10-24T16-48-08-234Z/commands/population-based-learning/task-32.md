# population-based-learning - Task 32

Execute task 32 for the population-based-learning specification.

## Task Description
Add crossover method with retry logic

## Code Reuse
**Leverage existing code**: logging, generate
...
## Usage
```
/Task:32-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add crossover method with retry logic"

```
Use the @spec-task-executor agent to implement task 32: "Add crossover method with retry logic" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Add crossover method with retry logic
- Leverage: logging, generate
- Requirements: R3.2

## Instructions
- Implement ONLY task 32: "Add crossover method with retry logic"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 32 --mode complete
```
