# population-based-learning - Task 30

Execute task 30 for the population-based-learning specification.

## Task Description
Add factor weight renormalization to parameter_crossover
...
## Usage
```
/Task:30-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add factor weight renormalization to parameter_crossover"

```
Use the @spec-task-executor agent to implement task 30: "Add factor weight renormalization to parameter_crossover" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Add factor weight renormalization to parameter_crossover
- Requirements: R3.1

## Instructions
- Implement ONLY task 30: "Add factor weight renormalization to parameter_crossover"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 30 --mode complete
```
