# population-based-learning - Task 43

Execute task 43 for the population-based-learning specification.

## Task Description
Implement evaluate_population method
...
## Usage
```
/Task:43-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement evaluate_population method"

```
Use the @spec-task-executor agent to implement task 43: "Implement evaluate_population method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: Implement evaluate_population method
- Leverage: autonomous
- Requirements: R1.3, R6.1

## Instructions
- Implement ONLY task 43: "Implement evaluate_population method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 43 --mode complete
```
