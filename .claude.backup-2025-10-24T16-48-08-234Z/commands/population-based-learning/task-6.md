# population-based-learning - Task 6

Execute task 6 for the population-based-learning specification.

## Task Description
Create unit tests for data models in tests/evolution/test_types.py

## Code Reuse
**Leverage existing code**: pytest, tests/helpers/testUtils.ts
...
## Usage
```
/Task:6-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create unit tests for data models in tests/evolution/test_types.py"

```
Use the @spec-task-executor agent to implement task 6: "Create unit tests for data models in tests/evolution/test_types.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create unit tests for data models in tests/evolution/test_types.py
- Leverage: pytest, tests/helpers/testUtils.ts
- Requirements: R1.3, R6.1

## Instructions
- Implement ONLY task 6: "Create unit tests for data models in tests/evolution/test_types.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 6 --mode complete
```
