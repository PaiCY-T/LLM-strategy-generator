# template-evolution-system - Task 7

Execute task 7 for the template-evolution-system specification.

## Task Description
Update Individual serialization with template_type

## Requirements Reference
**Requirements**: Requirement 6.1 (backward compatibility default)

## Usage
```
/Task:7-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update Individual serialization with template_type"

```
Use the @spec-task-executor agent to implement task 7: "Update Individual serialization with template_type" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Update Individual serialization with template_type
- Requirements: Requirement 6.1 (backward compatibility default)

## Instructions
- Implement ONLY task 7: "Update Individual serialization with template_type"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 7 --mode complete
```
