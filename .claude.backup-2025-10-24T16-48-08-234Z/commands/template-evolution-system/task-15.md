# template-evolution-system - Task 15

Execute task 15 for the template-evolution-system specification.

## Task Description
Update crossover offspring to inherit template_type

## Usage
```
/Task:15-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update crossover offspring to inherit template_type"

```
Use the @spec-task-executor agent to implement task 15: "Update crossover offspring to inherit template_type" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Update crossover offspring to inherit template_type

## Instructions
- Implement ONLY task 15: "Update crossover offspring to inherit template_type"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 15 --mode complete
```
