# template-evolution-system - Task 24

Execute task 24 for the template-evolution-system specification.

## Task Description
Update FitnessEvaluator.evaluate() to pass template_type

## Requirements Reference
**Requirements**: Requirement 4.3 (template-based routing)

## Usage
```
/Task:24-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update FitnessEvaluator.evaluate() to pass template_type"

```
Use the @spec-task-executor agent to implement task 24: "Update FitnessEvaluator.evaluate() to pass template_type" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Update FitnessEvaluator.evaluate() to pass template_type
- Requirements: Requirement 4.3 (template-based routing)

## Instructions
- Implement ONLY task 24: "Update FitnessEvaluator.evaluate() to pass template_type"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 24 --mode complete
```
