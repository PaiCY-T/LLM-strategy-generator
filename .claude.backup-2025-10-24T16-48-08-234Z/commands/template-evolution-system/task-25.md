# template-evolution-system - Task 25

Execute task 25 for the template-evolution-system specification.

## Task Description
Add unified diversity calculation to EvolutionMonitor

## Code Reuse
**Leverage existing code**: Design document Shannon entropy formula

## Requirements Reference
**Requirements**: Requirement 5.3 (template distribution in diversity)

## Usage
```
/Task:25-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add unified diversity calculation to EvolutionMonitor"

```
Use the @spec-task-executor agent to implement task 25: "Add unified diversity calculation to EvolutionMonitor" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Add unified diversity calculation to EvolutionMonitor
- Leverage: Design document Shannon entropy formula
- Requirements: Requirement 5.3 (template distribution in diversity)

## Instructions
- Implement ONLY task 25: "Add unified diversity calculation to EvolutionMonitor"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 25 --mode complete
```
