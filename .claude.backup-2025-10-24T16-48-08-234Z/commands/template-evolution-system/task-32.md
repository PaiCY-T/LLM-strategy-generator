# template-evolution-system - Task 32

Execute task 32 for the template-evolution-system specification.

## Task Description
Implement template distribution logic

## Requirements Reference
**Requirements**: Requirement 3.1, 3.3 (equal distribution default)

## Usage
```
/Task:32-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement template distribution logic"

```
Use the @spec-task-executor agent to implement task 32: "Implement template distribution logic" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Implement template distribution logic
- Requirements: Requirement 3.1, 3.3 (equal distribution default)

## Instructions
- Implement ONLY task 32: "Implement template distribution logic"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 32 --mode complete
```
