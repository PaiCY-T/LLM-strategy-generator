...
# 4. Apply filters
# Mandatory Liquidity filter: Average daily trading value > 70M TWD over 20 days
liquidity_filter = trading_value.rolling(20).mean().shift(1) > 70_000_000
# Mandatory Price filter: Stock price > 20 TWD
