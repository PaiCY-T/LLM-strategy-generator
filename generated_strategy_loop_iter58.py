...
# Factor 4: Institutional Flow (Foreign Net Buy, 10-day sum)
...
# Value filter: P/E ratio < 25 (avoiding extremely overvalued stocks, allowing for growth)
pe_filter = (pe_ratio.ffill().shift(1) > 0) & (pe_ratio.ffill().shift(1) < 25)
# Technical filter: RSI between 30 and 70 (avoiding extreme overbought/oversold conditions)
