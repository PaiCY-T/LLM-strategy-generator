...
# Forward-fill quarterly data to daily frequency and shift
quality = roe.rolling(4).mean().ffill().shift(1)
# Factor 3: Revenue Growth (monthly data aligned to daily)
# Forward-fill monthly data to daily frequency and shift
...
combined_factor = (momentum_rank * 0.30 +
                   ...
                   flow_rank * 0.20)
# 4. Apply filters
# Mandatory Liquidity filter: Average trading value over 20 days > 75M TWD
liquidity_filter = trading_value.rolling(20).mean().shift(1) > 75_000_000
# Mandatory Price filter: Close price > 20 TWD
price_filter = close.shift(1) > 20
# Optional Technical filter: RSI between 30 and 70 to avoid extreme overbought/oversold
