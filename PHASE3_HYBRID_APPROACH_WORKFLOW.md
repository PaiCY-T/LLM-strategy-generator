...
```mermaid
graph TD
    A[Step 1: 更新 requirements.md] --> B[Step 2: zen:planner - Week 1 規劃]
    B --> C[Step 3: 更新 tasks.md]
    C --> D[並行執行 - Week 1 任務]

    D --> E1[Task 1.1: ConfigManager 提取]
    D --> E2[Task 1.2: LLMClient 提取]
    D --> E3[Task 1.3: IterationHistory 驗證]

    E1 --> F[Week 1 完成檢查點]
    E2 --> F
    E3 --> F

    F --> G[Step 4: zen:planner - Week 2+ 功能開發]
    G --> H[Step 5: 開始 Phase 3 功能開發]
