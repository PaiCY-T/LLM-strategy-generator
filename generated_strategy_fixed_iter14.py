...
# Factor 5: Oversold Signal (RSI < 30) - inverted for ranking
oversold_signal = (rsi.shift(1) < 30).astype(int) # 1 if oversold, 0 otherwise
...
oversold_rank = oversold_signal.rank(axis=1, pct=True) # Rank the oversold signal
# Assign weights. Higher weight to momentum, quality, and institutional flow.
# Give a moderate weight to revenue growth and a smaller weight to oversold signal.
...
# 6. Run backtest
# Rebalance quarterly with a stop loss of 8%
