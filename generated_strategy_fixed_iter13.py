...
# Factor 5: Oversold condition (RSI < 40)
oversold_signal = (rsi.shift(1) < 40).astype(int) # Convert boolean to int for ranking
...
# Assign weights - higher weight to momentum, quality, and flow
