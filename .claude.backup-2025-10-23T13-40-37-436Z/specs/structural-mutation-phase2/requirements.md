...
- **Phase 2.0+ Fusion Decision**: `.claude/specs/structural-mutation-phase2/PHASE2_FUSION_DECISION.md`
- **Deep Analysis**: Gemini 2.5 Pro thinkdeep workflow (2025-10-20)
- **Expert Analysis**: Factor Graph System architectural insights
- **Population-based Learning Spec**: `.claude/specs/population-based-learning/` (Phase 1 foundation)
