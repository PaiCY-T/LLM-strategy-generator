# template-evolution-system - Task 22

Execute task 22 for the template-evolution-system specification.

## Task Description
Update _generate_and_backtest to accept template_type parameter

## Requirements Reference
**Requirements**: Requirement 4.1, 4.2 (template routing)

## Usage
```
/Task:22-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update _generate_and_backtest to accept template_type parameter"

```
Use the @spec-task-executor agent to implement task 22: "Update _generate_and_backtest to accept template_type parameter" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Update _generate_and_backtest to accept template_type parameter
- Requirements: Requirement 4.1, 4.2 (template routing)

## Instructions
- Implement ONLY task 22: "Update _generate_and_backtest to accept template_type parameter"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 22 --mode complete
```
