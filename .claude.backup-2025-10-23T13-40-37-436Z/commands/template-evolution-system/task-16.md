# template-evolution-system - Task 16

Execute task 16 for the template-evolution-system specification.

## Task Description
Write unit tests for template mutation

## Usage
```
/Task:16-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Write unit tests for template mutation"

```
Use the @spec-task-executor agent to implement task 16: "Write unit tests for template mutation" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Write unit tests for template mutation

## Instructions
- Implement ONLY task 16: "Write unit tests for template mutation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 16 --mode complete
```
