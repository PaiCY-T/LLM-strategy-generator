# population-based-learning - Task 38

Execute task 38 for the population-based-learning specification.

## Task Description
Add factor weight renormalization to mutation
...
## Usage
```
/Task:38-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add factor weight renormalization to mutation"

```
Use the @spec-task-executor agent to implement task 38: "Add factor weight renormalization to mutation" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Add factor weight renormalization to mutation
- Requirements: R4.2

## Instructions
- Implement ONLY task 38: "Add factor weight renormalization to mutation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 38 --mode complete
```
