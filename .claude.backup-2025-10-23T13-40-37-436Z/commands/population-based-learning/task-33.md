# population-based-learning - Task 33

Execute task 33 for the population-based-learning specification.

## Task Description
Create unit tests for crossover.py
...
## Usage
```
/Task:33-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create unit tests for crossover.py"

```
Use the @spec-task-executor agent to implement task 33: "Create unit tests for crossover.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create unit tests for crossover.py
- Leverage: pytest, unittest.mock
- Requirements: R3.1, R3.2

## Instructions
- Implement ONLY task 33: "Create unit tests for crossover.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 33 --mode complete
```
