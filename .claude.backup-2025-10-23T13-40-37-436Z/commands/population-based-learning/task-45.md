# population-based-learning - Task 45

Execute task 45 for the population-based-learning specification.

## Task Description
Add elitism_replacement method

## Code Reuse
**Leverage existing code**: selection.get
...
## Usage
```
/Task:45-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add elitism_replacement method"

```
Use the @spec-task-executor agent to implement task 45: "Add elitism_replacement method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 45
- Description: Add elitism_replacement method
- Leverage: selection.get
- Requirements: R5.1, R5.2

## Instructions
- Implement ONLY task 45: "Add elitism_replacement method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 45 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 45 --mode complete
```
