# population-based-learning - Task 23

Execute task 23 for the population-based-learning specification.

## Task Description
Implement tournament_selection method

## Code Reuse
**Leverage existing code**: random module, src/evolution/multi
...
## Usage
```
/Task:23-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement tournament_selection method"

```
Use the @spec-task-executor agent to implement task 23: "Implement tournament_selection method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Implement tournament_selection method
- Leverage: random module, src/evolution/multi
- Requirements: R2.1

## Instructions
- Implement ONLY task 23: "Implement tournament_selection method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 23 --mode complete
```
