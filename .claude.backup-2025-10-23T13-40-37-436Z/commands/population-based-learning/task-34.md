# population-based-learning - Task 34

Execute task 34 for the population-based-learning specification.

## Task Description
Add crossover compatibility rules
...
## Usage
```
/Task:34-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add crossover compatibility rules"

```
Use the @spec-task-executor agent to implement task 34: "Add crossover compatibility rules" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Add crossover compatibility rules
- Requirements: R3.3

## Instructions
- Implement ONLY task 34: "Add crossover compatibility rules"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 34 --mode complete
```
