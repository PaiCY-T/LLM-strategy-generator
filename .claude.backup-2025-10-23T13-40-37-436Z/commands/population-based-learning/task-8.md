# population-based-learning - Task 8

Execute task 8 for the population-based-learning specification.

## Task Description
Add Max Drawdown calculation to src/backtest/metrics.py

## Code Reuse
**Leverage existing code**: NumPy for cumulative max
...
## Usage
```
/Task:8-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add Max Drawdown calculation to src/backtest/metrics.py"

```
Use the @spec-task-executor agent to implement task 8: "Add Max Drawdown calculation to src/backtest/metrics.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Add Max Drawdown calculation to src/backtest/metrics.py
- Leverage: NumPy for cumulative max
- Requirements: R6.1

## Instructions
- Implement ONLY task 8: "Add Max Drawdown calculation to src/backtest/metrics.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 8 --mode complete
```
