...
# Assign weights - prioritize momentum, quality, and institutional flow
combined_factor = (momentum_rank * 0.35 +
                   quality_rank * 0.30 +
                   flow_rank * 0.20 +
                   revenue_rank * 0.10 +
                   rsi_rank * 0.05) # Lower weight for RSI, mainly for filtering
# 4. Apply filters
...
rsi_overbought_filter = rsi_filter_factor < 80
# Combine all filters
