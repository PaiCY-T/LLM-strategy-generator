...
oversold_signal = (rsi.shift(1) < 30).astype(int) * -1 # Invert to rank higher for oversold
...
oversold_rank = oversold_signal.rank(axis=1, pct=True) # Rank the inverted signal
# Assign weights: Momentum, Quality, Revenue Growth, Institutional Flow, Oversold Signal
...
# RSI filter: Avoid extremely overbought stocks
