...
# Forward-fill quarterly data to daily, then apply shift
quality = roe.ffill().rolling(4).mean().shift(1)
# Factor 3: Growth (Monthly Revenue YoY)
# Forward-fill monthly data to daily, then apply shift
...
# Valuation filter: P/E Ratio < 30 (forward-fill monthly data to daily, then apply shift)
