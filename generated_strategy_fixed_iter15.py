...
rsi_rank = rsi_signal.rank(axis=1, pct=True) # Rank the RSI signal
# Assign weights - prioritizing momentum, quality, and institutional flow
combined_factor = (momentum_rank * 0.30 +
                   ...
                   rsi_rank * 0.05)
# 4. Apply filters
# Liquidity filter: Average daily trading value over last 20 days > 50M TWD
