...
# Factor 5: RSI (short-term momentum/reversal signal)
rsi_signal = (rsi.shift(1) - 50) / 50 # Normalize RSI to be around 0, positive for uptrend, negative for downtrend
...
# Assign weights: Momentum and Quality are key, Revenue and Flow add diversification, RSI for short-term adjustment
...
# Price filter: adjusted close price > 15 TWD to avoid penny stocks
price_filter = close.shift(1) > 15
# RSI filter: avoid extremely overbought or oversold conditions for the composite signal
