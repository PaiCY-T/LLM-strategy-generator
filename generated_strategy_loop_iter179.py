...
# Weights: Momentum (0.25), Quality (0.20), Growth (0.20), Institutional Flow (0.20), Value (0.15)
...
# ROE filter: Positive ROE (basic quality check)
roe_positive_filter = roe.rolling(4, min_periods=1).mean().ffill().shift(1) > 0
# Apply all filters
filtered_factor = combined_factor[liquidity_filter & price_filter & pe_filter & roe_positive_filter]
# 5. Select top N stocks (12 stocks)
