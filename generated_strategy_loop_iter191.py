...
growth_revenue = monthly_revenue_yoy.ffill().shift(1)
...
value_pe = (1 / (pe_ratio + 1e-6)).ffill().shift(1)
...
# P/E Ratio filter: P/E between 0 and 25 (avoiding negative P/E and extremely high P/E)
