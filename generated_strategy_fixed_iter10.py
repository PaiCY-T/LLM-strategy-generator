...
# Assign weights: Momentum and Quality are key, Revenue and Flow add diversification, RSI as a contrarian element
combined_factor = (momentum_rank * 0.30 +
                   quality_rank * 0.30 +
                   revenue_rank * 0.20 +
                   flow_rank * 0.15 +
                   rsi_rank * 0.05) # Small weight for RSI
# 4. Apply filters
...
rsi_overbought_filter = rsi_filter_factor < 75
rsi_oversold_filter = rsi_filter_factor > 25
