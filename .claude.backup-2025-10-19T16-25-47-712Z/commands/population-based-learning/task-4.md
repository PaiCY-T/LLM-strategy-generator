# population-based-learning - Task 4

Execute task 4 for the population-based-learning specification.

## Task Description
Define Population dataclass in src/evolution/types.py
...
## Usage
```
/Task:4-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Define Population dataclass in src/evolution/types.py"

```
Use the @spec-task-executor agent to implement task 4: "Define Population dataclass in src/evolution/types.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Define Population dataclass in src/evolution/types.py
- Leverage: Python dataclasses
- Requirements: R1.2

## Instructions
- Implement ONLY task 4: "Define Population dataclass in src/evolution/types.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 4 --mode complete
```
