# population-based-learning - Task 28

Execute task 28 for the population-based-learning specification.

## Task Description
Create crossover.py with CrossoverManager class
...
## Usage
```
/Task:28-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create crossover.py with CrossoverManager class"

```
Use the @spec-task-executor agent to implement task 28: "Create crossover.py with CrossoverManager class" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Create crossover.py with CrossoverManager class
- Requirements: R3.1

## Instructions
- Implement ONLY task 28: "Create crossover.py with CrossoverManager class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 28 --mode complete
```
