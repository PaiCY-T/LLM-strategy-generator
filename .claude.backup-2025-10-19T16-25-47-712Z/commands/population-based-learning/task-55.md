# population-based-learning - Task 55

Execute task 55 for the population-based-learning specification.

## Task Description
Add progress visualization during evolution

## Code Reuse
**Leverage existing code**: src/evolution/visualization.py
...
## Usage
```
/Task:55-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add progress visualization during evolution"

```
Use the @spec-task-executor agent to implement task 55: "Add progress visualization during evolution" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 55
- Description: Add progress visualization during evolution
- Leverage: src/evolution/visualization.py
- Requirements: R11.1

## Instructions
- Implement ONLY task 55: "Add progress visualization during evolution"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 55 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 55 --mode complete
```
