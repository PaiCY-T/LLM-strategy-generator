...
# Factor 2: Fundamental Strength (Combined ROE and Revenue Growth)
...
# Combine ROE and revenue growth for a fundamental strength score
# We will normalize these separately and then combine for the factor
# This is a conceptual combination, actual combination happens after individual ranking
...
# Combine fundamental ranks into a single fundamental factor
fundamental_strength_rank = (roe_rank * 0.6 + revenue_rank * 0.4)
# Combine all main factors with weights
combined_factor = (momentum_rank * 0.40 +
                   fundamental_strength_rank * 0.35 +
                   flow_rank * 0.25)
# 4. Apply filters
...
# RSI filter: Avoid stocks in extreme overbought/oversold conditions (RSI between 30 and 70)
