...
# ROE: Use 4-quarter rolling average and forward-fill
quality_roe = roe.rolling(4).mean().ffill().shift(1)
# Revenue Growth: Forward-fill monthly data
growth_revenue = revenue_yoy.ffill().shift(1)
# Combine quality and growth into one factor
quality_growth = (quality_roe + growth_revenue) / 2 # Simple average, will be ranked later
...
# Market Cap filter: Market value > 10 Billion TWD for larger, more stable companies
