...
# Prioritize momentum and quality, with growth and institutional flow as supporting signals
combined_factor = (momentum_rank * 0.35 +
                   quality_rank * 0.30 +
                   growth_rank * 0.20 +
                   flow_rank * 0.15)
# 4. Apply filters
# Mandatory Liquidity filter: Average daily trading value over 20 days > 70M TWD
liquidity_filter = trading_value.rolling(20).mean().shift(1) > 70_000_000
# Mandatory Price filter: Close price > 20 TWD to avoid penny stocks
price_filter = close.shift(1) > 20
# Optional Technical filter: RSI between 30 and 70 to avoid extreme overbought/oversold conditions
