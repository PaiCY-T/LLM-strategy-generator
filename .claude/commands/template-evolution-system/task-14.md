# template-evolution-system - Task 14

Execute task 14 for the template-evolution-system specification.

## Task Description
Implement same-template crossover check

## Requirements Reference
**Requirements**: Requirement 2.1, 2.2 (same-template crossover only)

## Usage
```
/Task:14-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement same-template crossover check"

```
Use the @spec-task-executor agent to implement task 14: "Implement same-template crossover check" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Implement same-template crossover check
- Requirements: Requirement 2.1, 2.2 (same-template crossover only)

## Instructions
- Implement ONLY task 14: "Implement same-template crossover check"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 14 --mode complete
```
