# template-evolution-system - Task 43

Execute task 43 for the template-evolution-system specification.

## Task Description
Run multi-template evolution in sandbox

## Usage
```
/Task:43-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Run multi-template evolution in sandbox"

```
Use the @spec-task-executor agent to implement task 43: "Run multi-template evolution in sandbox" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: Run multi-template evolution in sandbox

## Instructions
- Implement ONLY task 43: "Run multi-template evolution in sandbox"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 43 --mode complete
```
