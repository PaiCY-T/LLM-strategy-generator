# template-evolution-system - Task 19

Execute task 19 for the template-evolution-system specification.

## Task Description
Write integration test: same-template crossover enforcement

## Usage
```
/Task:19-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Write integration test: same-template crossover enforcement"

```
Use the @spec-task-executor agent to implement task 19: "Write integration test: same-template crossover enforcement" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: Write integration test: same-template crossover enforcement

## Instructions
- Implement ONLY task 19: "Write integration test: same-template crossover enforcement"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 19 --mode complete
```
