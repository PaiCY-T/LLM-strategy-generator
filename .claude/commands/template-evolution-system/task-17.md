# template-evolution-system - Task 17

Execute task 17 for the template-evolution-system specification.

## Task Description
Write unit tests for template-aware crossover

## Usage
```
/Task:17-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Write unit tests for template-aware crossover"

```
Use the @spec-task-executor agent to implement task 17: "Write unit tests for template-aware crossover" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Write unit tests for template-aware crossover

## Instructions
- Implement ONLY task 17: "Write unit tests for template-aware crossover"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 17 --mode complete
```
