# template-evolution-system - Task 23

Execute task 23 for the template-evolution-system specification.

## Task Description
Update _get_cache_key to include template_type (defense-in-depth)

## Code Reuse
**Leverage existing code**: Design document cache key pattern

## Usage
```
/Task:23-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update _get_cache_key to include template_type (defense-in-depth)"

```
Use the @spec-task-executor agent to implement task 23: "Update _get_cache_key to include template_type (defense-in-depth)" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Update _get_cache_key to include template_type (defense-in-depth)
- Leverage: Design document cache key pattern

## Instructions
- Implement ONLY task 23: "Update _get_cache_key to include template_type (defense-in-depth)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 23 --mode complete
```
