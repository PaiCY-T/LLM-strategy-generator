# template-evolution-system - Task 4

Execute task 4 for the template-evolution-system specification.

## Task Description
Add template_type attribute to Individual class

## Code Reuse
**Leverage existing code**: src/utils/template

## Requirements Reference
**Requirements**: Requirement 1.2 (template validation)

## Usage
```
/Task:4-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add template_type attribute to Individual class"

```
Use the @spec-task-executor agent to implement task 4: "Add template_type attribute to Individual class" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Add template_type attribute to Individual class
- Leverage: src/utils/template
- Requirements: Requirement 1.2 (template validation)

## Instructions
- Implement ONLY task 4: "Add template_type attribute to Individual class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 4 --mode complete
```
