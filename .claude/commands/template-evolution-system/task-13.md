# template-evolution-system - Task 13

Execute task 13 for the template-evolution-system specification.

## Task Description
b. Add invariance tests for genetic operators (CONSENSUS IMPROVEMENT)

## Usage
```
/Task:13-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "b. Add invariance tests for genetic operators (CONSENSUS IMPROVEMENT)"

```
Use the @spec-task-executor agent to implement task 13: "b. Add invariance tests for genetic operators (CONSENSUS IMPROVEMENT)" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: b. Add invariance tests for genetic operators (CONSENSUS IMPROVEMENT)

## Instructions
- Implement ONLY task 13: "b. Add invariance tests for genetic operators (CONSENSUS IMPROVEMENT)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 13 --mode complete
```
