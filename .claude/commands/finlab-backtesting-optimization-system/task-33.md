# finlab-backtesting-optimization-system - Task 33

Execute task 33 for the finlab-backtesting-optimization-system specification.

## Task Description
Add syntax highlighting for code display

## Code Reuse
**Leverage existing code**: pygments library

## Requirements Reference
**Requirements**: AC-5.6, Design Component 3

## Usage
```
/Task:33-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add syntax highlighting for code display"

```
Use the @spec-task-executor agent to implement task 33: "Add syntax highlighting for code display" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Add syntax highlighting for code display
- Leverage: pygments library
- Requirements: AC-5.6, Design Component 3

## Instructions
- Implement ONLY task 33: "Add syntax highlighting for code display"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 33 --mode complete
```
