# finlab-backtesting-optimization-system - Task 66

Execute task 66 for the finlab-backtesting-optimization-system specification.

## Task Description
Implement strategy comparison screen (Screen 7)

## Code Reuse
**Leverage existing code**: ComparisonEngine, HighlightedComparison, CodeDiff

## Requirements Reference
**Requirements**: AC-9.1, AC-9.2, AC-9.3, AC-9.4, Design Component 9 Screen 7

## Usage
```
/Task:66-finlab-backtesting-optimization-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement strategy comparison screen (Screen 7)"

```
Use the @spec-task-executor agent to implement task 66: "Implement strategy comparison screen (Screen 7)" for the finlab-backtesting-optimization-system specification and include all the below context.
...
## Task Details
- Task ID: 66
- Description: Implement strategy comparison screen (Screen 7)
- Leverage: ComparisonEngine, HighlightedComparison, CodeDiff
- Requirements: AC-9.1, AC-9.2, AC-9.3, AC-9.4, Design Component 9 Screen 7

## Instructions
- Implement ONLY task 66: "Implement strategy comparison screen (Screen 7)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 66 --mode complete
...
```bash
claude-code-spec-workflow get-tasks finlab-backtesting-optimization-system 66 --mode complete
```
