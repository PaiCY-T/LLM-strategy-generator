# template-system-phase2 - Task 37

Execute task 37 for the template-system-phase2 specification.

## Task Description
Implement template match scoring
...
## Usage
```
/Task:37-template-system-phase2
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement template match scoring"

```
Use the @spec-task-executor agent to implement task 37: "Implement template match scoring" for the template-system-phase2 specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Implement template match scoring
- Requirements: 4.1

## Instructions
- Implement ONLY task 37: "Implement template match scoring"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-system-phase2 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-system-phase2 37 --mode complete
```
