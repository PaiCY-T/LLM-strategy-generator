# architecture-contradictions-fix - Task 2.3.3

Execute task 2.3.3 for the architecture-contradictions-fix specification.

## Task Description
更新 `_decide_generation_method()`

## Usage
```
/Task:2.3.3-architecture-contradictions-fix
```

## Instructions

Execute with @spec-task-executor agent the following task: "更新 `_decide_generation_method()`"

```
Use the @spec-task-executor agent to implement task 2.3.3: "更新 `_decide_generation_method()`" for the architecture-contradictions-fix specification and include all the below context.
...
## Task Details
- Task ID: 2.3.3
- Description: 更新 `_decide_generation_method()`

## Instructions
- Implement ONLY task 2.3.3: "更新 `_decide_generation_method()`"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks architecture-contradictions-fix 2.3.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks architecture-contradictions-fix 2.3.3 --mode complete
```
