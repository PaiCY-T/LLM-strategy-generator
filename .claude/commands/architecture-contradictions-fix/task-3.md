# architecture-contradictions-fix - Task 3

Execute task 3 for the architecture-contradictions-fix specification.
...
## Usage
```
/Task:3-architecture-contradictions-fix
```

## Instructions

Execute with @spec-task-executor agent the following task: "人团队完成时间 ≤ 10 天"

```
Use the @spec-task-executor agent to implement task 3: "人团队完成时间 ≤ 10 天" for the architecture-contradictions-fix specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: 人团队完成时间 ≤ 10 天

## Instructions
- Implement ONLY task 3: "人团队完成时间 ≤ 10 天"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks architecture-contradictions-fix 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks architecture-contradictions-fix 3 --mode complete
```
