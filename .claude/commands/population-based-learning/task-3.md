# population-based-learning - Task 3

Execute task 3 for the population-based-learning specification.

## Task Description
Define Strategy dataclass in src/evolution/types.py

## Code Reuse
**Leverage existing code**: Python dataclasses, UUID
...
## Usage
```
/Task:3-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Define Strategy dataclass in src/evolution/types.py"

```
Use the @spec-task-executor agent to implement task 3: "Define Strategy dataclass in src/evolution/types.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Define Strategy dataclass in src/evolution/types.py
- Leverage: Python dataclasses, UUID
- Requirements: R1.3

## Instructions
- Implement ONLY task 3: "Define Strategy dataclass in src/evolution/types.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 3 --mode complete
```
