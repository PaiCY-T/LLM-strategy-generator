# population-based-learning - Task 22

Execute task 22 for the population-based-learning specification.

## Task Description
Create selection.py with SelectionManager class
...
## Usage
```
/Task:22-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create selection.py with SelectionManager class"

```
Use the @spec-task-executor agent to implement task 22: "Create selection.py with SelectionManager class" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create selection.py with SelectionManager class
- Requirements: R2.1

## Instructions
- Implement ONLY task 22: "Create selection.py with SelectionManager class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 22 --mode complete
```
