# population-based-learning - Task 14

Execute task 14 for the population-based-learning specification.

## Task Description
Add visualization helper in src/evolution/visualization.py

## Code Reuse
**Leverage existing code**: Matplotlib
...
## Usage
```
/Task:14-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add visualization helper in src/evolution/visualization.py"

```
Use the @spec-task-executor agent to implement task 14: "Add visualization helper in src/evolution/visualization.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Add visualization helper in src/evolution/visualization.py
- Leverage: Matplotlib
- Requirements: R6.3

## Instructions
- Implement ONLY task 14: "Add visualization helper in src/evolution/visualization.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 14 --mode complete
```
