# population-based-learning - Task 20

Execute task 20 for the population-based-learning specification.

## Task Description
Create unit tests for diversity.py
...
## Usage
```
/Task:20-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create unit tests for diversity.py"

```
Use the @spec-task-executor agent to implement task 20: "Create unit tests for diversity.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create unit tests for diversity.py
- Leverage: pytest
- Requirements: R7.1

## Instructions
- Implement ONLY task 20: "Create unit tests for diversity.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 20 --mode complete
```
