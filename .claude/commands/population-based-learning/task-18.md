# population-based-learning - Task 18

Execute task 18 for the population-based-learning specification.

## Task Description
Add calculate_population_diversity to diversity.py
...
## Usage
```
/Task:18-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add calculate_population_diversity to diversity.py"

```
Use the @spec-task-executor agent to implement task 18: "Add calculate_population_diversity to diversity.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Add calculate_population_diversity to diversity.py
- Leverage: calculate
- Requirements: R7.1

## Instructions
- Implement ONLY task 18: "Add calculate_population_diversity to diversity.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 18 --mode complete
```
