# population-based-learning - Task 56

Execute task 56 for the population-based-learning specification.

## Task Description
Create full integration test (5 generations, N=20)

## Code Reuse
**Leverage existing code**: pytest, PopulationManager
...
## Usage
```
/Task:56-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create full integration test (5 generations, N=20)"

```
Use the @spec-task-executor agent to implement task 56: "Create full integration test (5 generations, N=20)" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 56
- Description: Create full integration test (5 generations, N=20)
- Leverage: pytest, PopulationManager
- Requirements: All

## Instructions
- Implement ONLY task 56: "Create full integration test (5 generations, N=20)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 56 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 56 --mode complete
```
