# population-based-learning - Task 49

Execute task 49 for the population-based-learning specification.

## Task Description
Create evolutionary_prompt_builder.py
...
## Usage
```
/Task:49-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create evolutionary_prompt_builder.py"

```
Use the @spec-task-executor agent to implement task 49: "Create evolutionary_prompt_builder.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 49
- Description: Create evolutionary_prompt_builder.py
- Leverage: src/prompt
- Requirements: R8.2

## Instructions
- Implement ONLY task 49: "Create evolutionary_prompt_builder.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 49 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 49 --mode complete
```
