# population-based-learning - Task 44

Execute task 44 for the population-based-learning specification.

## Task Description
Implement evolve_generation method

## Code Reuse
**Leverage existing code**: selection, crossover, mutation, multi

## Requirements Reference
**Requirements**: R2.1, R3.1, R4.1, R5.1

## Usage
```
/Task:44-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement evolve_generation method"

```
Use the @spec-task-executor agent to implement task 44: "Implement evolve_generation method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: Implement evolve_generation method
- Leverage: selection, crossover, mutation, multi
- Requirements: R2.1, R3.1, R4.1, R5.1

## Instructions
- Implement ONLY task 44: "Implement evolve_generation method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 44 --mode complete
```
