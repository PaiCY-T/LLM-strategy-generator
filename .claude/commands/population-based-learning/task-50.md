# population-based-learning - Task 50

Execute task 50 for the population-based-learning specification.

## Task Description
Add build_crossover_prompt method

## Code Reuse
**Leverage existing code**: base PromptBuilder.build

## Requirements Reference
**Requirements**: R3.2, R8.2

## Usage
```
/Task:50-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add build_crossover_prompt method"

```
Use the @spec-task-executor agent to implement task 50: "Add build_crossover_prompt method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 50
- Description: Add build_crossover_prompt method
- Leverage: base PromptBuilder.build
- Requirements: R3.2, R8.2

## Instructions
- Implement ONLY task 50: "Add build_crossover_prompt method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 50 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 50 --mode complete
```
