# population-based-learning - Task 51

Execute task 51 for the population-based-learning specification.

## Task Description
Add build_mutation_prompt method

## Code Reuse
**Leverage existing code**: base PromptBuilder.build

## Requirements Reference
**Requirements**: R4.3, R8.2

## Usage
```
/Task:51-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add build_mutation_prompt method"

```
Use the @spec-task-executor agent to implement task 51: "Add build_mutation_prompt method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 51
- Description: Add build_mutation_prompt method
- Leverage: base PromptBuilder.build
- Requirements: R4.3, R8.2

## Instructions
- Implement ONLY task 51: "Add build_mutation_prompt method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 51 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 51 --mode complete
```
