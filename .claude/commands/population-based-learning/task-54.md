# population-based-learning - Task 54

Execute task 54 for the population-based-learning specification.

## Task Description
Add metrics extraction integration

## Code Reuse
**Leverage existing code**: src/backtest/metrics.py

## Requirements Reference
**Requirements**: R6.1, R8.3

## Usage
```
/Task:54-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add metrics extraction integration"

```
Use the @spec-task-executor agent to implement task 54: "Add metrics extraction integration" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 54
- Description: Add metrics extraction integration
- Leverage: src/backtest/metrics.py
- Requirements: R6.1, R8.3

## Instructions
- Implement ONLY task 54: "Add metrics extraction integration"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 54 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 54 --mode complete
```
