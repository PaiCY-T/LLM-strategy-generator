# population-based-learning - Task 7

Execute task 7 for the population-based-learning specification.

## Task Description
Add Calmar ratio calculation to src/backtest/metrics.py

## Code Reuse
**Leverage existing code**: existing Sharpe ratio calculation
...
## Usage
```
/Task:7-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add Calmar ratio calculation to src/backtest/metrics.py"

```
Use the @spec-task-executor agent to implement task 7: "Add Calmar ratio calculation to src/backtest/metrics.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Add Calmar ratio calculation to src/backtest/metrics.py
- Leverage: existing Sharpe ratio calculation
- Requirements: R6.1

## Instructions
- Implement ONLY task 7: "Add Calmar ratio calculation to src/backtest/metrics.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 7 --mode complete
```
