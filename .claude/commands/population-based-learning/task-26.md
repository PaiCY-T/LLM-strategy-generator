# population-based-learning - Task 26

Execute task 26 for the population-based-learning specification.

## Task Description
Create unit tests for selection.py
...
## Usage
```
/Task:26-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create unit tests for selection.py"

```
Use the @spec-task-executor agent to implement task 26: "Create unit tests for selection.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Create unit tests for selection.py
- Leverage: pytest, unittest.mock
- Requirements: R2.1

## Instructions
- Implement ONLY task 26: "Create unit tests for selection.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 26 --mode complete
```
