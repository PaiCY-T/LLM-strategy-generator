# population-based-learning - Task 24

Execute task 24 for the population-based-learning specification.

## Task Description
Implement select_parents method

## Code Reuse
**Leverage existing code**: tournament
...
## Usage
```
/Task:24-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement select_parents method"

```
Use the @spec-task-executor agent to implement task 24: "Implement select_parents method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Implement select_parents method
- Leverage: tournament
- Requirements: R2.1

## Instructions
- Implement ONLY task 24: "Implement select_parents method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 24 --mode complete
```
