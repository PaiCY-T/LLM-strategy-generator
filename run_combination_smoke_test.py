...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('combination_smoke_test.log')
    ]
)
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='Population size (default: 10 for smoke test, 20 for validation)'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='Number of generations (default: 10 for smoke test, 20 for validation)'
    )
    ...
    parser.add_argument(
        '--checkpoint-dir',
        type=str,
        default='combination_smoke_checkpoints',
...
def main():
    ...
    try:
        for gen in range(1, args.generations + 1):  # 10 generations
            print(f"\n{'='*70}")
    ...
    print(f"Logs saved to: combination_smoke_test.log\n")
