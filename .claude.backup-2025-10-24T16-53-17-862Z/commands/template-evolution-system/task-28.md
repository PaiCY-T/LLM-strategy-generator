# template-evolution-system - Task 28

Execute task 28 for the template-evolution-system specification.

## Task Description
Write unit tests for FitnessEvaluator template routing

## Usage
```
/Task:28-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Write unit tests for FitnessEvaluator template routing"

```
Use the @spec-task-executor agent to implement task 28: "Write unit tests for FitnessEvaluator template routing" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Write unit tests for FitnessEvaluator template routing

## Instructions
- Implement ONLY task 28: "Write unit tests for FitnessEvaluator template routing"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 28 --mode complete
```
