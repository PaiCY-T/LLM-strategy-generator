# template-evolution-system - Task 6

Execute task 6 for the template-evolution-system specification.

## Task Description
Update Individual.validate_parameters() to use template validation

## Code Reuse
**Leverage existing code**: src/templates/base

## Requirements Reference
**Requirements**: Requirement 1.3 (template-specific PARAM

## Usage
```
/Task:6-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update Individual.validate_parameters() to use template validation"

```
Use the @spec-task-executor agent to implement task 6: "Update Individual.validate_parameters() to use template validation" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Update Individual.validate_parameters() to use template validation
- Leverage: src/templates/base
- Requirements: Requirement 1.3 (template-specific PARAM

## Instructions
- Implement ONLY task 6: "Update Individual.validate_parameters() to use template validation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 6 --mode complete
```
