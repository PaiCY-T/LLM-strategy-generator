# template-evolution-system - Task 18

Execute task 18 for the template-evolution-system specification.

## Task Description
Write integration test: template mutation in evolution

## Usage
```
/Task:18-template-evolution-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Write integration test: template mutation in evolution"

```
Use the @spec-task-executor agent to implement task 18: "Write integration test: template mutation in evolution" for the template-evolution-system specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Write integration test: template mutation in evolution

## Instructions
- Implement ONLY task 18: "Write integration test: template mutation in evolution"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks template-evolution-system 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks template-evolution-system 18 --mode complete
```
