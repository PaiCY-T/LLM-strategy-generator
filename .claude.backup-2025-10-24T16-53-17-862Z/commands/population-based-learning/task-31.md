# population-based-learning - Task 31

Execute task 31 for the population-based-learning specification.

## Task Description
Implement generate_offspring_code method

## Code Reuse
**Leverage existing code**: src/prompt
...
## Usage
```
/Task:31-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement generate_offspring_code method"

```
Use the @spec-task-executor agent to implement task 31: "Implement generate_offspring_code method" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Implement generate_offspring_code method
- Leverage: src/prompt
- Requirements: R3.2

## Instructions
- Implement ONLY task 31: "Implement generate_offspring_code method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 31 --mode complete
```
