# population-based-learning - Task 47

Execute task 47 for the population-based-learning specification.

## Task Description
Add diversity monitoring and adaptation

## Code Reuse
**Leverage existing code**: diversity.calculate
...
## Usage
```
/Task:47-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add diversity monitoring and adaptation"

```
Use the @spec-task-executor agent to implement task 47: "Add diversity monitoring and adaptation" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 47
- Description: Add diversity monitoring and adaptation
- Leverage: diversity.calculate
- Requirements: R7.2

## Instructions
- Implement ONLY task 47: "Add diversity monitoring and adaptation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 47 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 47 --mode complete
```
