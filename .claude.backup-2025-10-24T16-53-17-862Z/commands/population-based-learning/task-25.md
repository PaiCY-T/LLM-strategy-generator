# population-based-learning - Task 25

Execute task 25 for the population-based-learning specification.

## Task Description
Add diversity-aware selection probability

## Code Reuse
**Leverage existing code**: src/evolution/diversity.calculate
...
## Usage
```
/Task:25-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add diversity-aware selection probability"

```
Use the @spec-task-executor agent to implement task 25: "Add diversity-aware selection probability" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Add diversity-aware selection probability
- Leverage: src/evolution/diversity.calculate
- Requirements: R2.3

## Instructions
- Implement ONLY task 25: "Add diversity-aware selection probability"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 25 --mode complete
```
