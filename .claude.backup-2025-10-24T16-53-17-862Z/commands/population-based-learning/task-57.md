# population-based-learning - Task 57

Execute task 57 for the population-based-learning specification.

## Task Description
Add command-line interface for running evolution

## Code Reuse
**Leverage existing code**: argparse, PopulationManager
...
## Usage
```
/Task:57-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add command-line interface for running evolution"

```
Use the @spec-task-executor agent to implement task 57: "Add command-line interface for running evolution" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 57
- Description: Add command-line interface for running evolution
- Leverage: argparse, PopulationManager
- Requirements: R11.1, R11.2

## Instructions
- Implement ONLY task 57: "Add command-line interface for running evolution"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 57 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 57 --mode complete
```
