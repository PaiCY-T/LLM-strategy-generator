# population-based-learning - Task 16

Execute task 16 for the population-based-learning specification.

## Task Description
Create diversity.py with extract_feature_set function

## Code Reuse
**Leverage existing code**: Python re module
...
## Usage
```
/Task:16-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create diversity.py with extract_feature_set function"

```
Use the @spec-task-executor agent to implement task 16: "Create diversity.py with extract_feature_set function" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Create diversity.py with extract_feature_set function
- Leverage: Python re module
- Requirements: R7.1

## Instructions
- Implement ONLY task 16: "Create diversity.py with extract_feature_set function"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 16 --mode complete
```
