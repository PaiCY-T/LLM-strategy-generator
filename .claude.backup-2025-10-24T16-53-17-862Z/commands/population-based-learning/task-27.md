# population-based-learning - Task 27

Execute task 27 for the population-based-learning specification.

## Task Description
Add elitism preservation to selection.py
...
## Usage
```
/Task:27-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add elitism preservation to selection.py"

```
Use the @spec-task-executor agent to implement task 27: "Add elitism preservation to selection.py" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Add elitism preservation to selection.py
- Requirements: R5.1

## Instructions
- Implement ONLY task 27: "Add elitism preservation to selection.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 27 --mode complete
```
