# population-based-learning - Task 58

Execute task 58 for the population-based-learning specification.

## Task Description
Create 20-generation validation script

## Code Reuse
**Leverage existing code**: PopulationManager
...
## Usage
```
/Task:58-population-based-learning
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create 20-generation validation script"

```
Use the @spec-task-executor agent to implement task 58: "Create 20-generation validation script" for the population-based-learning specification and include all the below context.
...
## Task Details
- Task ID: 58
- Description: Create 20-generation validation script
- Leverage: PopulationManager
- Requirements: All

## Instructions
- Implement ONLY task 58: "Create 20-generation validation script"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks population-based-learning 58 --mode complete
...
```bash
claude-code-spec-workflow get-tasks population-based-learning 58 --mode complete
```
